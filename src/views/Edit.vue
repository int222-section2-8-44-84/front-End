...
<!-- Edit -->
        ...
        <div class="grid bg-white rounded-lg shadow-xl w-11/12 md:w-9/12 lg:w-1/2 mb-12">
            ...
            <input v-model="postTitle" class="py-2 px-3 rounded-lg border-2  mt-1 focus:outline-none focus:ring-2 focus:ring-yellow-600 focus:border-transparent" type="text" placeholder="PostTitle" />
            ...
            <input v-model="foodName" class="py-2 px-3 rounded-lg border-2  mt-1 focus:outline-none focus:ring-2 focus:ring-yellow-600 focus:border-transparent" type="text" placeholder="FoodName" />
            ...
            <input v-model="restaurant" class="py-2 px-3 rounded-lg border-2  mt-1 focus:outline-none focus:ring-2 focus:ring-yellow-600 focus:border-transparent" type="text" placeholder="Restaurant" />
            ...
            <div class="grid grid-cols-1 mt-5 mx-7">
              ...
              <textarea v-model="description" class="h-28 px-3 rounded-lg border-2 mt-1 focus:outline-none focus:ring-2 focus:ring-yellow-600 focus:border-transparent" type="text" placeholder="Description"></textarea>
            ...
            <div class='flex items-center justify-center md:gap-8 gap-4 pt-5 pb-5 xl:px-8 md:px-8'>
                ...
                <base-button type="submit" class="bg-yellow-400 hover:bg-yellow-500 rounded-lg px-4 py-2" label="Update"/>
            </div>
        </div>
        </div>       
        </form>
...
export default {
  ...
  methods: {
    ...
    async editAllPostsData(){ 
      ...
      await fetch(`${this.urladdupload}/${this.postNumber}`, {
        method: "PUT",
        body: formData
      });
